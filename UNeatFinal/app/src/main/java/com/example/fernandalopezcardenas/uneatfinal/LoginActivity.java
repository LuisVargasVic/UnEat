                        ...
                        .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    if (myRef.toString().equals("Client")){
                                        Intent client = new Intent(LoginActivity.this, MainClientActivity.class);
                                        startActivity(client);
                                    }
                                    else{
                                        Intent restaurant = new Intent(LoginActivity.this, MainRestaurantActivity.class);
