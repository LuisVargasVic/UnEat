    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                writeNewPurchase(userId, item.getUID(), message, item);
                Intent MapOne= new Intent(CarActivity.this, MainClientActivity.class);
                startActivity(MapOne);
            }
        });
    }
    private void writeNewPurchase(String UIDC, String UIDR, String message, DetailPlate plate) {
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DetailCart user = new DetailCart(UIDC, UIDR, message, plate);
