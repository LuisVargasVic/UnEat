                        ...
                        .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    myRef.child("users").child("data").child(userId).child("rol");
                                    if (myRef.toString().equals("Restaurant")){
                                        Intent client = new Intent(LoginActivity.this, MainRestaurantActivity.class);
                                        startActivity(client);
                                    }
                                    else{
                                        Intent restaurant = new Intent(LoginActivity.this, MainClientActivity.class);
