    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                final List<DetailRestaurant> areas = new ArrayList<>();
                for (DataSnapshot areaSnapshot: dataSnapshot.getChildren()) {
                    DetailRestaurant value1 = areaSnapshot.getValue(DetailRestaurant.class);
                    Log.wtf("value1", value1.toString());
                    areas.add(value1);
                }
                areasAdapter = new ArrayAdapter<>(RestaurantActivity.this, android.R.layout.simple_expandable_list_item_1, areas);
