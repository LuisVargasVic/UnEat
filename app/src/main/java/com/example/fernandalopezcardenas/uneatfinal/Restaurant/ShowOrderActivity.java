    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                final List<String> areasSTR = new ArrayList<>();
                for (DataSnapshot areaSnapshot: dataSnapshot.getChildren()) {
                    DetailCart value1 = areaSnapshot.getValue(DetailCart.class);
                    areas.add(value1);
                    areasSTR.add(value1.getUidrequest());
                }
                areasAdapter = new ArrayAdapter<>(ShowOrderActivity.this, android.R.layout.simple_expandable_list_item_1, areasSTR);
